...
internal class RealtimeManager {
    ...
    internal static void InternalLeaveRoomCallback(Status.ResponseStatus response, IntPtr data) {
        GPLogger.d("Entering internal callback for InternalLeaveRoomCallback");
        ...
        try {
            ...
            GPLogger.e("Error encountered executing InternalLeaveRoomCallback. " +
    ...
    internal static void InternalSendReliableMessageCallback(Status.MultiplayerStatus response,
        IntPtr data) {
        GPLogger.d("Entering internal callback for InternalSendReliableMessageCallback " + response);
        ...
        try {
            ...
            GPLogger.e("Error encountered executing InternalSendReliableMessageCallback. " +
                "Smothering to avoid passing exception into Native: " + e);
        }
    }
